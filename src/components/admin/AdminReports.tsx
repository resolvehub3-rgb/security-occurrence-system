  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl font-bold text-stone-900 tracking-tight">Finalized Shift Reports Library</h1>
          <p className="text-xs text-stone-500">Authoritative, manager-approved and archived occurrence reports</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredReports.map((rep) => (
            <div
              ...
              className="p-5 bg-white rounded-3xl border border-stone-200/90 shadow-2xs hover:border-orange-300 transition cursor-pointer space-y-3"
            >
              ...
              <div className="p-3 bg-stone-50 rounded-2xl border border-stone-200/60 text-xs space-y-1 text-stone-600">
